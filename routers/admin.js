...
router.delete("/manage-payments/delete/:id", isAdmin, adminController.deletePaymentMethod);
router.post("/manage-payments/toggle/:id", isAdmin, adminController.togglePaymentMethod);
...
router.post("/user/:id/toggle-status", isAdmin, adminController.toggleUserStatus);
...
router.post('/whatsapp/update/:id', isAdmin , adminController.editWhatsAppNumber);
router.post('/whatsapp/delete/:id', isAdmin , adminController.deleteWhatsAppNumber);
