...
// Mathematically balanced for 96% RTP to maximize addiction and fairness
const RISK = {
    easy:  [8.6, 8.7, 10.2, 11.7, 12.1, 15.4, 17.0, 21.7, 25.0, 27.3],
    mod:   [14.3, 17.0, 20.6, 22.7, 26.7, 28.6, 30.0, 33.3, 40.0, 50.0],
    hard:  [23.2, 26.5, 32.0, 37.5, 38.5, 40.9, 45.0, 55.6, 55.0, 66.7],
    pro:   [35.1, 40.8, 50.0, 58.3, 60.0, 62.5, 68.0, 68.8, 73.3, 70.0]
};
